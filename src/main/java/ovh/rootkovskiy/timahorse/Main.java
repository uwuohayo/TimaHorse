...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        instance = this;
        Bukkit.getPluginCommand("horse").setExecutor((CommandExecutor)new HorseExecutor());
        Bukkit.getPluginCommand("horseon").setExecutor((CommandExecutor)new HorseOnExecutor());
        Bukkit.getPluginCommand("horseoff").setExecutor((CommandExecutor)new HorseOffExecutor());
